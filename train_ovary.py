'''
Training code for OvaryUSDataset datasets segmentation
Written by Whalechen/Savc
'''
...
if __name__ == '__main__':
    ...
    sets.save_folder=f'./trails/ovary/models/{sets.model}_{sets.model_depth}'
    ...
    training_dataset = OvaryUSDataset(sets.data_root, sets.img_list, sets)
